...
function showPlanets(list) {
  ...
  for (var i = 0; i < list.length; i++) {
    ...
    planetName.className = " col-12 col-md-12 col-sm-12 planetName";
    planetName.textContent = planet.name;

    var description = document.createElement("div");
    description.className = "planet-desc";
...
document.getElementById("tab2").addEventListener("click" , function(){
    showPlanets([planets[0]]);
})

document.getElementById("tab3").addEventListener("click" , function(){
    showPlanets([planets[1]]);
})

document.getElementById("tab4").addEventListener("click" , function(){
    showPlanets([planets[2]]);
})

document.getElementById("tab5").addEventListener("click" , function(){
    showPlanets([planets[3]]);
})

document.getElementById("tab6").addEventListener("click" , function(){
    showPlanets([planets[4]]);
})
document.getElementById("tab7").addEventListener("click" , function(){
    showPlanets([planets[5]]);
})
document.getElementById("tab8").addEventListener("click" , function(){
    showPlanets([planets[6]]);
})
document.getElementById("tab9").addEventListener("click" , function(){
    showPlanets([planets[7]]);
})
...
function comparePlanets() {
    var p1 = document.getElementById("planet1").value.trim().toLowerCase();
    var p2 = document.getElementById("planet2").value.trim().toLowerCase();
